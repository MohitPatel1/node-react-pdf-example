export const appLevelOptions = {
	clientCompanyCategories: ["CUSTOMER", "SUPPLIER", "PAIR - CUSTOMER & SUPPLIER"],
	clientEnterpriseTypes: ["MICRO", "SMALL", "MEDIUM"],
	clientCompanyActivities: ["MANUFACTURING", "TRADERS", "DISTRIBUTION", "RETAILERS", "RESELLERS", "SERVICE"],
	calculateCommissionOnOptions: ["GROSS AMOUNT BEFORE TAX", "PRODUCTS LEVEL TOTAL", "TOTAL INVOICE AMOUNT"],
	otherChargeTypes: [
		"OTHERS",
		"INTEREST",
		"BANK COMMISSION",
	...
	drTypeOtherCharges: ["OTHERS", "INTEREST"],
	commissionCollectFrom: ["CUSTOMER", "SUPPLIER", "SUB-BROKER SUPPLIER", "SUB-BROKER CUSTOMER"],
	currencyOptions: ["INR", "USD"],
	defaultUOM: "PCS",
	gstPercentage: [5, 12, 18, 28],
	moduleOptions: ["AGENCY", "TRADER", "AADATH", "MANUFACTURER"],
	orderRateModes: ["included in price", "5%", "12%", "18%", "28%"],
	paymentModeOption: ["CASH", "CHEQUE", "ONLINE", "NEFT", "RTGS"],
	transportPaymentModes: ["PAID", "TO-PAY"],
	uomOptions: ["PCS", "KGS", "MTR", "BALE", "LUMP", "ROLL", "THAN", "SET"],
	gstUomOptions: [
		"PIECES",
		"METERS",
		"DOZEN",
...
export const getCurrentFinancialYear = () => {
	...
	if (currentMonth < 4) {
		// If current month is before April, it's still the previous financial year.
		financialYearStart = (currentYear - 1) % 100;
		financialYearEnd = currentYear % 100;
	} else {
		// Else, it's the current year's financial year.
		financialYearStart = currentYear % 100;
		financialYearEnd = (currentYear + 1) % 100;
	}

	return financialYearStart * 100 + financialYearEnd;
};